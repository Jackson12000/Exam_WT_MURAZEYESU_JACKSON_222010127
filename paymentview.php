...
<header>
  ...
  <div class="container">
    <a href='/onlinetutor/payment.php' class="add">New Add</a>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>{$row['makeAt']}</td> 
                <td>
                  <a href='/onlinetutor/paymentedit.php?payment_id={$row['payment_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/onlinetutor/paymentdelete.php?payment_id={$row['payment_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
