...
<body>
  ...
  <div class="container">
    <div class="form-box">
      <form action="tutoradd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Tutors</h2>
        <p id="result"></p>
        <div class="input-box">
        ...
        <div class="input-box">
        <label class="leb" for="description">Description</label>
...
<div class="input-box">
<label  class="leb" for="hourly_rate">Hourly Rate</label>
<input class="input" type="number" id="hourly_rate" name="hourly_rate" placeholder="Enter hourly rate" required>
				</div>
        <div class="input-box">
        <label class="leb" for="availability">Availability</label>
          <input type="text" required name="availability" placeholder="Enter Availability" >
        </div>

        <div class="button">
          <input type="submit" value="Record" onclick="validation()" class="btn"> <br>
