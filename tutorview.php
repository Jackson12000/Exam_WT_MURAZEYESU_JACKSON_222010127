...
<header>
  ...
  <div class="container">
    <a href='/onlinetutor/tutor.php' class="add">New Add</a>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>
                  <a href='/onlinetutor/tutoredit.php?tutor_id={$row['tutor_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/onlinetutor/tutordelete.php?tutor_id={$row['tutor_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
