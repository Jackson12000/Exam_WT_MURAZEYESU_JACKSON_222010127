...
<header>
		...
		<ul>
			...
			<li><a href="#"> Forms<i class="fas fa-caret-down"></i></a>
				<div class="dropdown_menu">
					<ul><li><a href="subject.php">Subjects<i class="fas fa-caret-right"></i></a>
  ...
  <div class="container">
    <a href='/onlinetutor/notification.php' class="add">New Add</a>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>{$row['makeAt']}</td> 
                <td>
                  <a href='/onlinetutor/notificationedit.php?notification_id={$row['notification_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/onlinetutor/notificationdelete.php?notification_id={$row['notification_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
