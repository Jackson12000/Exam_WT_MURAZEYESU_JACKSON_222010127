...
<header>
  ...
  <div class="container">
    <a href='/onlinetutor/student.php' class="add">New Add</a>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>{$row['makeAt']}</td> 
                <td>
                  <a href='/onlinetutor/studentedit.php?student_id={$row['student_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/onlinetutor/studentdelete.php?student_id={$row['student_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
