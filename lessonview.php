...
<header>
  ...
  <div class="container">
    <a href='/onlinetutor/lesson.php' class="add">New Add</a>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>{$row['duration']}</td>  
                <td>{$row['date_Time']}</td>
                <td>{$row['lesson_status']}</td>
                 
                <td>
                  <a href='/onlinetutor/lessonedit.php?lesson_id={$row['lesson_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/onlinetutor/lessondelete.php?lesson_id={$row['lesson_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
