...
<header>
  ...
  <div class="container">
    <div class="form-box">
      <form action="bookadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Booking</h2>
        <p id="result"></p>
...
<div class="input-box">
<label class="label">Tutors Id</label><br>
...
?>
  ...
  <div class="input-box">
        <label class="leb" for="booking_date">Booking Date</label> 

          <input type="date" required  name="booking_date" placeholder="Enter Booking_Date" >
        </div>
        <div class="input-box">
        <label class="leb" for="payment_status">Payments Status</label>
          <input type="text" required name="payment_status" placeholder="Enter Payment Status" >
        </div>
        <div class="button">
          <input type="submit" value="Booking" onclick="validation()" class="btn"> <br> <br>
