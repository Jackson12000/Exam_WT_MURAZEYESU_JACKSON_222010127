...
<header>
  ...
  <div class="container">
    <div class="form-box">
      <form action="sessionadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Sessions</h2>
        <p id="result"></p>
...
?>
        ...
        <label class="leb" for="Session Type"></label> 

          <input type="text" required  name="session_type" placeholder="Enter Session_Type" >
        </div>
        
        <div class="button">
          <input type="submit" value="Records" onclick="validation()" class="btn"> <br> <br>
