...
<header>
  ...
  <div class="container">
    <div class="form-box">
      <form action="lessonadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Lesson</h2>
        <p id="result"></p>
...
?>
        ...
        <label class="leb" for="duration">Duration</label> 

          <input type="text" required  name="duration" placeholder="Enter Duration" >
        </div>
        <div class="input-box">
        <label class="leb" for="lesson_status">Lesson Status</label>
          <input type="text" required name="lesson_status" placeholder="Enter lesson status" >
        </div>
        <div class="button">
