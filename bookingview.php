...
<header>
  ...
  <img class="logo" src="online.jpg" alt="Logo">
        ...
        <li><a href="#"> Tables<i class="fas fa-caret-down"></i></a>
          ...
          <li><a href="tutorview.php">Tutor View</a></li>
						<li><a href="bookingview.php">SBookings<i class="fas fa-caret-right"></i></a>
  ...
  <div class="container">
    <a href='/onlinetutor/booking.php' class="add">New Add</a>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>
                  <a href='/onlinetutor/bookingedit.php?booking_id={$row['booking_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/onlinetutor/bookingdelete.php?booking_id={$row['booking_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
